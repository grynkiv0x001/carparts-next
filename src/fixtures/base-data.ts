...
export const carModels: CarModel[] = [
  // Toyota
  { id: "model-001", manufacturerId: "mfg-001", name: "Camry", years: [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  { id: "model-002", manufacturerId: "mfg-001", name: "Corolla", years: [2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  { id: "model-003", manufacturerId: "mfg-001", name: "RAV4", years: [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  { id: "model-004", manufacturerId: "mfg-001", name: "Highlander", years: [2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  { id: "model-005", manufacturerId: "mfg-001", name: "Tacoma", years: [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  
  // Ford
  { id: "model-006", manufacturerId: "mfg-002", name: "F-150", years: [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  { id: "model-007", manufacturerId: "mfg-002", name: "Mustang", years: [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  { id: "model-008", manufacturerId: "mfg-002", name: "Explorer", years: [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  { id: "model-009", manufacturerId: "mfg-002", name: "Escape", years: [2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  
  // Chevrolet
  { id: "model-010", manufacturerId: "mfg-003", name: "Silverado", years: [2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  { id: "model-011", manufacturerId: "mfg-003", name: "Equinox", years: [2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  { id: "model-012", manufacturerId: "mfg-003", name: "Malibu", years: [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  
  // Honda
  { id: "model-013", manufacturerId: "mfg-004", name: "Civic", years: [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  { id: "model-014", manufacturerId: "mfg-004", name: "Accord", years: [2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  { id: "model-015", manufacturerId: "mfg-004", name: "CR-V", years: [2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  
  // BMW
  { id: "model-016", manufacturerId: "mfg-005", name: "3 Series", years: [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  { id: "model-017", manufacturerId: "mfg-005", name: "5 Series", years: [2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  { id: "model-018", manufacturerId: "mfg-005", name: "X5", years: [2019, 2020, 2021, 2022, 2023, 2024] },
  
  // Mercedes-Benz
  { id: "model-019", manufacturerId: "mfg-006", name: "C-Class", years: [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  { id: "model-020", manufacturerId: "mfg-006", name: "E-Class", years: [2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  
  // Volkswagen
  { id: "model-021", manufacturerId: "mfg-007", name: "Jetta", years: [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  { id: "model-022", manufacturerId: "mfg-007", name: "Passat", years: [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  
  // Nissan
  { id: "model-023", manufacturerId: "mfg-009", name: "Altima", years: [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  { id: "model-024", manufacturerId: "mfg-009", name: "Rogue", years: [2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  
  // Hyundai
  { id: "model-025", manufacturerId: "mfg-010", name: "Elantra", years: [2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
  { id: "model-026", manufacturerId: "mfg-010", name: "Tucson", years: [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
];
